						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Thi Cuối Học Kỳ</span>
									<span class="white" id="id-text2">13TCLC</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy;  Triệu Thị Ly Ly</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
												...
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Tên người dùng" name="membername"/>
										...
										<div class="toolbar clearfix">
											<div>
												<a href="HomeFwd"  class="forgot-password-link">
